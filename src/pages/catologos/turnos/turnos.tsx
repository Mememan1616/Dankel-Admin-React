...
export default function TurnosCrud() {
    ...
    }, [turnos, searchTerm, filtroEstatus]);
                        ...
                        <table className="w-full text-left border-collapse whitespace-nowrap min-w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th className="px-6 py-4 font-medium text-slate-700 dark:text-slate-200">Hora inicio</th>
                                    <th className="px-6 py-4 font-medium text-slate-700 dark:text-slate-200">Hora término</th>
